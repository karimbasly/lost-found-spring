...
public class PdfCoreBuilder {
    ...
    private static final int QR_CODE_PERCENT = 30;
    private static final int IMAGE_WIDTH = 160;

    private static final int THERMAL_FONT_SIZE = 11;
    private static final int THERMAL_FONT_SIZE_EMPHASIZED = 11;
    ...
    public PdfCoreBuilder qrCode(String code) {
        ...
        Paragraph paragraph = new Paragraph("Referencia: " + code);
    ...
    public PdfCoreBuilder head() {
        this
                .image("logo-text.png")
                .br()
                .paragraphEmphasized("Master en Ingeniería Web. Automundo")
    ...
    public PdfCoreBuilder foot() {
        this
                .line()
                .paragraphEmphasized("Nota de Aviso.")
                .paragraph("El precio se ha estimado haciendo un primer diagnóstico del coche. Por tanto, puede variar en caso de encontrar un nuevo fallo al hacer el mantenimiento.")
                .paragraph("Solamente se realizará el mantenimiento cuando usted acepte este diagnóstico y la condición antes descrita.")
                .paragraphEmphasized("Gracias por elegirnos. Si tienes una sugerencia, puedes enviarla a nuestra dirección de email: soporte@automundo.com")
                .line();
        return this;
    }
